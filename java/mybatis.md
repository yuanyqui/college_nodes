...
1. 将mybatis核心配置文件放入maven架构下的resources目录下面![image-20230523125758668](assets/image-20230523125758668.png)

[logback.xml](./resources/logback.xml)

[mybatis-config.xml](./resources/mybatis-config.xml)

2. 在mybatis-config.xml文件里面设置数据库连接和对SQL数据的映射位置信息

   ![](assets/image-20230523130549455-16848191037361.png)
...
4. 创造一个接口类和同名xml文件形成解析以后的映射关系

   ![](assets/image-20230522210054240.png)

5. 编写一个test类在里面编写增删改查

   ![image-20230523131451908](assets/image-20230523131451908.png)
